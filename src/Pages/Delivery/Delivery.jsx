    ...
    <CustomBox>
      <CustomContainer>
        <Box>
          ...
          <Typography sx={{ fontSize: "16px", color: "#000", fontWeight: "800", fontFamily: "monospace" }}>Door to Door Delivery</Typography>

          <CustomButton backgroundColor="#fff" color="#17275f" buttonText="Order Now!"></CustomButton>
        </Box>
